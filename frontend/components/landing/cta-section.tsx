            ...
            <div className="flex items-center justify-between gap-8">
              <div className="max-w-2xl">
                ...
                <p className="text-lg text-background/70 mb-8 leading-relaxed max-w-lg">
                  Try the dashboard, chat, receipt scanner, reports, activity logs, and agent monitor. 
                  Each workflow is backed by server APIs and Terminal3 proof envelopes.
                </p>
                ...
                <div className="flex flex-col sm:flex-row items-start gap-4">
                  ...
                  <Button
                    ...
                    asChild
                  >
                    <a href="/agents">Inspect agents</a>
                  </Button>
                </div>
